...
<body>
    ...
    <script>
        ...
        function handleReviewSubmit(event) {
            event.preventDefault(); // Задерживаем мгновенную отправку формы, чтобы показать анимацию
            ...
            // Ждем 2.5 секунды (показываем анимацию загрузки), затем отправляем форму
            setTimeout(() => {
                form.submit();
            }, 2500);
        }
